# This is a code scrap from a project I worked on during my last internship. The function of this code is to collect game players' data from storage base. I choose this code as a demo because it can explain part of my work during my last internship in game industry and show my ability to build pipeline and process game data.
